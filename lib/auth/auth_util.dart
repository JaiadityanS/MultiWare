...
DocumentReference? get currentUserReference => currentUser?.user != null
    ? AgriConnect6063dRecord.collection.doc(currentUser!.user!.uid)
    : null;

AgriConnect6063dRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : AgriConnect6063dRecord.getDocument(
                  AgriConnect6063dRecord.collection.doc(uid))
              .handleError((_) {}),
    )
